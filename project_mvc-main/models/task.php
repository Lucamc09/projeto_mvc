...
class Task {
    ...
    public function create() {
        $query = "INSERT INTO " . $this->table_tarefa . " (tarefa, prazo) VALUES (:tarefa, :prazo)";
    ...
    public function readOne() {
        $query = "SELECT tarefa, prazo FROM " . $this->table_tarefa . " WHERE id = ? LIMIT 0,1";
        $stmt = $this->conn->prepare($query);
    ...
    public function update() {
        $query = "UPDATE " . $this->table_tarefa . " SET tarefa = :tarefa, prazo = :prazo WHERE id = :id";
        $stmt = $this->conn->prepare($query);
    ...
    public function delete() {
        $query = "DELETE FROM " . $this->table_tarefa . " WHERE id = ?";
        $stmt = $this->conn->prepare($query);
        $stmt->bindParam(1, $this->id);
